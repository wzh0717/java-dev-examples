...
public abstract class DateUtils {
    ...
    public static String getCurrTimeString() {
        return getDateStr(new Date(), DateStyle.YYYY_MM_DD_HH_MM_SS.getValue());
    }
    ...
    public static WeekStyle getWeek(Date date) {
        ...
        switch (weekNumber) {
            case 0:
                WeekStyle = WeekStyle.SUNDAY;
                break;
            case 1:
                WeekStyle = WeekStyle.MONDAY;
                break;
            case 2:
                WeekStyle = WeekStyle.TUESDAY;
                break;
            case 3:
                WeekStyle = WeekStyle.WEDNESDAY;
                break;
            case 4:
                WeekStyle = WeekStyle.THURSDAY;
                break;
            case 5:
                WeekStyle = WeekStyle.FRIDAY;
                break;
            case 6:
                WeekStyle = WeekStyle.SATURDAY;
                break;
        }
        return WeekStyle;
    }
